...
# Dosya adi verilirse onu kullan; verilmezse klasordeki en yeni gorunen videoyu sec.
if [[ $# -ge 1 && -n "${1:-}" ]]; then
...
# uv cache Google Drive FUSE uzerinde izin sorunu cikarabildigi icin yerel diskte tutulur.
...
# -------- LatentSync: kod gecici, modeller Drive'da kalici --------
rm -rf "$LS_CODE"
...
# -------- 4) Kendi sesine benzer Japonca ses --------
